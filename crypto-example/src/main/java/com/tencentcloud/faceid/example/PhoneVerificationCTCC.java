 ...
 * 手机号三要素核验（电信）
 */
public class PhoneVerificationCTCC {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PhoneVerificationCTCCRequest request = PhoneVerificationCTCCRequest.fromJsonString(reqJson, PhoneVerificationCTCCRequest.class);

        // Step 3. 调用接口
        PhoneVerificationCTCCResponse response = faceidClient.PhoneVerificationCTCC(request);
        System.out.println("SDK response: " + PhoneVerificationCTCCResponse.toJsonString(response));
    }
