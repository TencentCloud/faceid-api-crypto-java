 ...
 * 手机号在网时长核验
 */
public class MobileNetworkTimeVerification {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MobileNetworkTimeVerificationRequest request = MobileNetworkTimeVerificationRequest.fromJsonString(reqJson, MobileNetworkTimeVerificationRequest.class);

        // Step 3. 调用接口
        MobileNetworkTimeVerificationResponse response = faceidClient.MobileNetworkTimeVerification(request);
        System.out.println("SDK response: " + MobileNetworkTimeVerificationResponse.toJsonString(response));
    }
